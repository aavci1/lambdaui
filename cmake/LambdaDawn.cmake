...
function(lambda_configure_dawn_subproject)
  ...
  set(TINT_BUILD_TINTD OFF CACHE BOOL "Build Tint language server." FORCE)
...
macro(lambda_push_dawn_compile_workarounds)
  ...
  if(CMAKE_CXX_COMPILER_ID MATCHES "GNU|Clang|AppleClang")
    # Current Dawn/Tint source builds can forward-declare uint32_t-backed scoped
    # enums before including <cstdint>. Keep the workaround scoped to Dawn.
